...
public class PhoneNumberActivity {
    ...
    // Get phone prefix for a given country code
    public static String getPhone(String code) {
        return country2phone.get(code.toUpperCase());
    }
    // Get the entire country code to phone prefix map
    public static Map<String, String> getAll(){
        return country2phone;
    }

    // Create a HashMap to store the country code to phone prefix mappings
